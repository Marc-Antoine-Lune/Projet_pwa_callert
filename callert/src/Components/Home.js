  ...
  return (
    <div>
      ...
      <div style={{lineHeight: 'initial'}}>
        ...
        <p class="subtitle">Choose a service to call</p>
      </div>
      <div class="cards" className={classes.cards}>
          <Card className={classes.card} style={{backgroundColor: '#3f51b5'}}>
            <Button id="pompier" style={{height: '100%'}}>
              ...
              <p class='btnLabel'>Pompier</p>
            </Button>
          </Card>
          <Card className={classes.card} style={{backgroundColor: '#3f51b5'}}>
            <Button id="ambulance" style={{height: '100%', backgroundColor: '#3f51b5'}}>
              <AmbulanceIcon style={{color: 'white'}}/>
              <p class='btnLabel'>Samu</p>
            </Button>
          </Card>
          <Card className={classes.card} style={{backgroundColor: '#3f51b5'}}>
            <Button id="police" style={{height: '100%', backgroundColor: '#3f51b5'}}>
              <SecurityIcon style={{color: 'white'}}/>
              <p class='btnLabel'>Police</p>
            </Button>
          </Card>
      </div>
      <div style={{lineHeight: 'initial'}}>
        <h2>Not sure what to do</h2>
        <p class="subtitle">Hold this button</p>
